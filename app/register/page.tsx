...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      {/* Background orbs */}
      <div
        className="fixed top-1/4 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-10 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #8b5cf6, transparent)' }}
      />
      <div
        className="fixed bottom-1/4 left-1/4 w-80 h-80 rounded-full blur-3xl opacity-10 pointer-events-none"
